...
arquivo_entrada = Path('data_exec_indiv/06_base_com_operadora.csv')
arquivo_insumos = Path('utils/insumos/insumos 5 estrelas.xlsx')
arquivo_saida = Path('data_exec_indiv/07_base_com_meta.csv')

pasta_resumo = Path('saida_resumo') / 'exec_07_meta'
