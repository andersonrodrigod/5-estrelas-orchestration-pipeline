...
arquivo_entrada = Path('data_exec_indiv/07_base_com_meta.csv')
arquivo_saida = Path('data_exec_indiv/08_base_com_resultado_unidade.csv')

pasta_resumo = Path('saida_resumo') / 'exec_08_resultado_unidade'
