...
arquivo_saida_tipo_1_a_7 = Path('data_exec/negativas/05_base_tipo_1_a_7.csv')
arquivo_saida_tipo_8_ou_mais = Path('data_exec/negativas/05_base_tipo_8_ou_mais.csv')

pasta_resumo = Path('auditoria') / 'saida_resumo_negativa' / 'exec_05_separar_tipo'
