...
arquivo_insumos_ndi = resolver_caminho_onedrive_comercial(
    Path('utils/insumos/Unidades ndi sp e rj.xlsx'),
    Path('5 Estrelas/INSUMOS/Unidades ndi sp e rj.xlsx'),
)
arquivo_saida = Path('data_exec/avaliacoes/06_base_com_operadora_legacy.csv')
...
arquivo_operadora_distintos_csv = pasta_resumo / 'exec_06_operadora_legacy_local_editado_operadora.csv'
arquivo_nao_classificados_csv = pasta_resumo / 'exec_06_operadora_legacy_nao_classificados.csv'
arquivo_sobrescritos_csv = pasta_resumo / 'exec_06_operadora_legacy_sobrescritos.csv'
arquivo_hapvida_distintos_csv = pasta_resumo / 'exec_06_operadora_legacy_hapvida_distintos.csv'
...
print('Iniciando execucao 06 legacy - operadora...')
...
resumo = {
    'execucao': 'exec_06_operadora_legacy',
