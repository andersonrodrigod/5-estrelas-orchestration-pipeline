...
arquivo_saida_tipo_1_a_7 = Path('data_exec/avaliacoes/11_base_tipo_1_a_7.csv')
arquivo_saida_tipo_8_ou_mais = Path('data_exec/avaliacoes/11_base_tipo_8_ou_mais.csv')
