...
arquivo_saida = Path('data_exec_indiv/avaliacoes/06_base_com_operadora_legacy_v1.csv')

pasta_resumo = Path('saida_resumo_avaliacoes') / 'exec_06_operadora_legacy_v1_legacy_v1'
arquivo_resumo_json = pasta_resumo / 'exec_06_operadora_legacy_v1_resumo.json'
arquivo_resumo_txt = pasta_resumo / 'exec_06_operadora_legacy_v1_resumo.txt'
arquivo_resumo_csv = pasta_resumo / 'exec_06_operadora_legacy_v1_resumo.csv'
arquivo_operadora_distintos_csv = pasta_resumo / 'exec_06_operadora_legacy_v1_local_editado_operadora.csv'
arquivo_nao_classificados_csv = pasta_resumo / 'exec_06_operadora_legacy_v1_nao_classificados.csv'
arquivo_sobrescritos_csv = pasta_resumo / 'exec_06_operadora_legacy_v1_sobrescritos.csv'
arquivo_hapvida_distintos_csv = pasta_resumo / 'exec_06_operadora_legacy_v1_hapvida_distintos.csv'
...
print('Iniciando execucao 06 legacy v1 - operadora...')
...
resumo = {
    'execucao': 'exec_06_operadora_legacy_v1',
...
linhas_txt = [
    'RESUMO DA EXECUCAO 06 LEGACY V1 - OPERADORA',
    '',
...
print('Execucao 06 legacy v1 finalizada.')
