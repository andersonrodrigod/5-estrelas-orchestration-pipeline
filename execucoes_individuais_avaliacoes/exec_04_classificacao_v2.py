...
pasta_resumo_espelho = Path('saida_resumo') / 'exec_04_classificacao_v2'
...
arquivo_auditoria_csv = pasta_resumo / 'exec_04_classificacao_v2_auditoria.csv'
arquivo_sobrescritas_csv = pasta_resumo / 'exec_04_classificacao_v2_sobrescritas.csv'
...
print('Iniciando execucao 04 v2 - classificacao por planilha de regras...')
...
resumo = {
    'execucao': 'exec_04_classificacao_v2',
...
linhas_txt = [
    'RESUMO DA EXECUCAO 04 V2 - CLASSIFICACAO',
    '',
    'ARQUIVOS:',
...
print('Execucao 04 v2 finalizada.')
