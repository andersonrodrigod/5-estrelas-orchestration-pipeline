...
arquivo_saida = Path('data_exec_indiv/avaliacoes/04_base_com_classificacao_legacy_v1.csv')

pasta_resumo = Path('saida_resumo_avaliacoes') / 'exec_04_classificacao_legacy_v1_legacy_v1'
pasta_resumo_espelho = Path('saida_resumo') / 'exec_04_classificacao_legacy_v1_legacy_v1'
arquivo_resumo_json = pasta_resumo / 'exec_04_classificacao_legacy_v1_resumo.json'
arquivo_resumo_txt = pasta_resumo / 'exec_04_classificacao_legacy_v1_resumo.txt'
arquivo_auditoria_csv = pasta_resumo / 'exec_04_classificacao_legacy_v1_auditoria.csv'
arquivo_sobrescritas_csv = pasta_resumo / 'exec_04_classificacao_legacy_v1_sobrescritas.csv'
arquivo_nao_classificados_detalhado_csv = pasta_resumo / 'exec_04_classificacao_legacy_v1_nao_classificados_detalhado.csv'
...
print('Iniciando execucao 04 legacy v1 - classificacao...')
...
resumo = {
    'execucao': 'exec_04_classificacao_legacy_v1',
...
linhas_txt = [
    'RESUMO DA EXECUCAO 04 LEGACY V1 - CLASSIFICACAO',
    '',
    'ARQUIVOS:',
...
print('Execucao 04 legacy v1 finalizada.')
