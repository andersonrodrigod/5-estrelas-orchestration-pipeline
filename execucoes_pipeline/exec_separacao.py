...
# Avaliacoes ja saem no layout historico usado pelo Power BI a partir da execucao 12.
arquivo_avaliacoes = Path('data_exec_indiv/avaliacoes/12_base_power_bi.csv')
arquivo_negativas = Path('data_exec_indiv/negativas/pipeline_pre_validacao_base_final.csv')
